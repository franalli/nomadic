        ...
        for i in range(1, base_count + 1):
            ...
            tiles.append(
                Tile(
                    ...
                    deeplink="https://example.com/hotel/mock?aff_id=DEMO",
                    rating=None,
                    review_count=None,
        ...
        for idx, option in enumerate(options[:max_results]):
            ...
            tiles.append(
                Tile(
                    ...
                    price_basis="per_trip",
                    is_estimate_only=source_mode == "cache",
                    deeplink="https://example.com/flights/search?aff_id=DEMO",
                    rating=None,
                    review_count=None,
        ...
        for idx, activity in enumerate(filtered_activities[:max_results]):
            ...
            tiles.append(
                Tile(
                    ...
                    price_basis="per_trip",
                    is_estimate_only=source_mode == "cache",
                    deeplink="https://example.com/activities/book?aff_id=DEMO",
                    rating=None,
                    review_count=None,
                    location_label=dest,
