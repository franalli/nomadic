...
Gates are listed in precedence order:
...
- 85: StrategyPreCoreValueWithDestGate
- 90: CoreCollectionGate
- 100: HighConfidenceGate
- 110: QuestionKeywordGate
- 120: KeywordHeuristicGate
- 999: RouterLLMGate
...
from app.planner.gates.implementations.heuristic_gates import (
    HighConfidenceGate,
...
from app.planner.gates.implementations.strategy_pre_core import (
