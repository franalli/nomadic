...
from app.planner.nodes.strategy.base import (
    STRATEGY_PRE_CORE_QUESTION_GUIDANCE as _STRATEGY_PRE_CORE_QUESTION_GUIDANCE,
)
from app.planner.nodes.strategy.base import (
    generate_date_suggestions as _generate_date_suggestions,
)
from app.planner.nodes.strategy.base import (
    is_strategy_enabled as _is_strategy_enabled,
)
from app.planner.nodes.strategy.base import (
    track_strategy_pre_core_question as _track_strategy_pre_core_question,
)
...
# Note: _generate_date_suggestions, _track_strategy_pre_core_question, and
# _should_escalate_from_stage0 are now imported from strategy.base module
