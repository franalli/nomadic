...
Use this agent as a 1:1 wrapper to `.claude/agents/backend-specialist.md`.

## Instructions

1. Open `.claude/agents/backend-specialist.md`.
2. Apply it verbatim as the active backend specialist spec.
3. If `.codex` and `.claude` differ, treat `.claude/agents/backend-specialist.md` as canonical.
