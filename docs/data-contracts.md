...
| `mergeTileEnrichment()`                                            | Merge post-response tile enrichment partial (conditional `day_cards`/`tiles` merge based on change flags, plus itinerary context) |
