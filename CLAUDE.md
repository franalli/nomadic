...
- **Active files:** `backend/app/config.py`, `backend/app/main.py`, `backend/app/planner/coordinator.py`, `backend/app/planner/conversationalist.py`, `backend/app/planner/nodes/expert_constraints.py`, `backend/app/planner/services/feasibility_service.py`, `backend/app/planner/specialist_registry.py`, `backend/app/prompts/specialists/local_expert.txt`, `backend/app/services/itinerary_builder.py`, `backend/app/tile_service/google_places_provider.py`, `backend/streaming.py`, `frontend/hooks/useChatSend.ts`, `frontend/hooks/useChatSse.ts`, `frontend/lib/api.ts`, `frontend/lib/googlePlacesPhoto.ts`, `frontend/next-env.d.ts`, `docs/repo_structure.md`, `docs/plan_graph_analysis.md`, `docs/data-contracts.md`, `docs/design-system.md`, `docs/ux_unified_architecture.md`, `.claude/plans/unified-dreaming-oasis.md`, `.claude/agents/frontend-specialist.md`, `.codex/agents/frontend-specialist.md`, `CLAUDE.md`
