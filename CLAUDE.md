...
- **Active files:** `backend/app/config.py`, `backend/app/data/demo_curation.py`, `backend/app/debug_utils.py`, `backend/app/lifespan.py`, `backend/app/main.py`, `backend/app/middleware/session.py`, `backend/app/planner/conversationalist.py`, `backend/app/planner/coordinator.py`, `backend/app/planner/nodes/constraint_guard.py`, `backend/app/planner/nodes/logistics_node.py`, `backend/app/planner/nodes/router_extraction.py`, `backend/app/planner/nodes/vertical_specialist.py`, `backend/app/planner/services/state_serde.py`, `backend/app/schemas.py`, `backend/app/services/activity_browser.py`, `backend/app/services/experience_generator.py`, `backend/app/services/itinerary_builder.py`, `backend/app/services/specialist_cache.py`, `backend/app/services/spend_guard.py`, `backend/app/services/tile_cache.py`, `backend/app/services/unsplash.py`, `backend/app/services/viator_provider.py`, `backend/app/tile_service/curated_provider.py`, `backend/app/tile_service/google_places_provider.py`, `backend/app/tile_service/mock_provider.py`, `backend/tests/run_curl_flows.sh`, `backend/tests/test_viator_provider.py`, `frontend/components/chat/ChatInputBar.tsx`, `frontend/components/chat/ChatInputHandler.tsx`, `frontend/components/chat/ChatModuleSheets.tsx`, `frontend/components/chat/ChatPanel.tsx`, `frontend/components/layout/LandingSheets.tsx`, `frontend/components/layout/MobileModeHeader.tsx`, `frontend/components/layout/MobileSwipeLayout.tsx`, `frontend/components/layout/NomadicLanding.tsx`, `frontend/components/layout/hooks/useBranchManager.ts`, `frontend/components/map/InteractiveMap.tsx`, `frontend/components/plan/PlanFullDensityView.tsx`, `frontend/components/plan/PlanTimelineSection.tsx`, `frontend/components/plan/sheets/ActivitiesSheetContent.tsx`, `frontend/components/plan/stages/S2AgentCard.tsx`, `frontend/components/plan/tiles/SuggestionCard.tsx`, `frontend/components/plan/tiles/SuggestionCardContent.tsx`, `frontend/components/plan/timeline/blocks/ActivityCardActions.tsx`, `frontend/components/plan/timeline/blocks/ActivityCardMeta.tsx`, `frontend/components/plan/timeline/blocks/ActivityCardPhoto.tsx`, `frontend/components/plan/timeline/blocks/ActivityMiniCard.tsx`, `frontend/components/plan/timeline/blocks/HoldToDeleteButton.tsx`, `frontend/components/shared/SharedTripView.tsx`, `frontend/components/tiles/MiniCardContent.tsx`, `frontend/components/tiles/TileCardContent.tsx`, `frontend/components/tiles/TileDetailsModal.tsx`, `frontend/hooks/useChatSend.ts`, `frontend/hooks/useChatSse.ts`, `frontend/hooks/usePreferenceAutoRegen.ts`, `frontend/lib/renderStarRating.ts`, `frontend/state/documentStore.ts`, `frontend/state/uiStore.ts`, `frontend/next.config.mjs`, `frontend/types/tile.ts`, `scripts/restart-dev.sh`, `docs/data-contracts.md`, `docs/design-system.md`, `docs/plan_graph_analysis.md`, `docs/repo_structure.md`, `docs/ux_unified_architecture.md`, `.claude/agents/backend-specialist.md`, `.claude/agents/frontend-specialist.md`, `.claude/agents/code-reviewer.md`, `.codex/agents/backend-specialist.md`, `.codex/agents/frontend-specialist.md`, `CLAUDE.md`
- **Active work:** UX and interaction polish, Viator-backed activity enrichment and affiliate deeplinks, short-trip/category-change regeneration hardening, session reset/auth chrome hardening, cost-aware recommendation optimizations, SSoT doc alignment in `docs/*`, and agent-spec trigger/ownership reconciliation
...
backend/.env → DATABASE_URL, OPENAI_API_KEY, GOOGLE_API_KEY, ROUTER_MODEL, EXTRACTION_MODEL, SPECIALIST_MODEL, LOCAL_EXPERT_MODEL, GUARD_MODEL, SYNTHESIZER_PLANNING_MODEL, SYNTHESIZER_EXPLORATION_MODEL, EXPERIENCE_MODEL, IATA_RESOLVER_MODEL, IATA_CACHE_TTL_HOURS, UNSPLASH_ACCESS_KEY, GOOGLE_MAPS_API_KEY, GOOGLE_MAPS_API_SECRET, VIATOR_API_KEY, VIATOR_ENABLED, VIATOR_CACHE_TTL_HOURS, VIATOR_API_URL, GOOGLE_OAUTH_CLIENT_ID, GOOGLE_OAUTH_CLIENT_SECRET, ADMIN_API_KEY, MEDIA_PROXY_SIGNING_KEY, FRONTEND_ORIGIN, COOKIE_DOMAIN, GOOGLE_PLACES_PHOTOS_ENABLED, MAX_SESSIONS_PER_IP_HOUR, DEBUG, DEBUG_PLAN_MESSAGES, CLEAR_L2_ON_RESET
